...
export const DEFAULT_UI_CONFIG: UIConfig = {
  ...
  strings: {
    ...
    heroPlatform:     'BUTLER INTELLIGENCE PLATFORM',
    heroDesc1:        'Your ',
    ...
    kbArticlesSubhead:  'The Butler crawler continuously indexes technical documentation, security advisories, and automation guides relevant to your workflow.',
