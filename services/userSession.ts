...
// ── ROUTES ───────────────────────────────────────────────────────
// NOTE: this project currently ships 3 tabs (index/connect/settings) and a
// root-level (non-tab) onboarding screen — not the full nexushome/9-tab
// layout these constants originally pointed at. Update both routes here if
