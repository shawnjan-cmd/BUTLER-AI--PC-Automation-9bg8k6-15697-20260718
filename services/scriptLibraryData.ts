...
const CAT_META: Record<string, {
  ...
  Files:       { title: 'File & Folder',         subtitle: 'Organize, backup, rename',       icon: 'folder',              iconLibrary: 'material',   color: '#FF7A1F' },
  System:      { title: 'System Tools',           subtitle: 'CPU, RAM, processes',            icon: 'computer',            iconLibrary: 'material',   color: '#38D9E8' },
  Web:         { title: 'Web & Scraping',         subtitle: 'Scrape, download, automate',     icon: 'web',                 iconLibrary: 'material',   color: '#2FE38A' },
  GUI:         { title: 'GUI Automation',         subtitle: 'Mouse, keyboard, windows',       icon: 'mouse',               iconLibrary: 'material',   color: '#FFC94A' },
  Email:       { title: 'Email & Notify',         subtitle: 'SMTP, Slack, Discord, alerts',   icon: 'email',               iconLibrary: 'material',   color: '#FF5FA8' },
  Data:        { title: 'Data Processing',        subtitle: 'CSV, Excel, PDF, SQLite',        icon: 'table-chart',         iconLibrary: 'material',   color: '#FFC94A' },
  Scheduling:  { title: 'Scheduling',             subtitle: 'Cron, timers, automation',       icon: 'schedule',            iconLibrary: 'material',   color: '#38D9E8' },
  Setup:       { title: 'Setup & DevOps',         subtitle: 'Dev env, Docker, git, CI/CD',    icon: 'build',               iconLibrary: 'material',   color: '#FF7A1F' },
  Network:     { title: 'Network & Monitoring',   subtitle: 'Scan, ping, ports, bandwidth',   icon: 'router',              iconLibrary: 'material',   color: '#2FE38A' },
  Text:        { title: 'Text & Docs',            subtitle: 'PDF, Word, regex, Markdown',     icon: 'description',         iconLibrary: 'material',   color: '#C3CFDF' },
  Monitoring:  { title: 'Monitoring & Alerts',    subtitle: 'Watch, alert, log, GPU, disk',   icon: 'monitor-heart',       iconLibrary: 'material',   color: '#FF4D5E' },
  Security:    { title: 'Security & Threat',      subtitle: 'Scan, harden, SSL, passwords',   icon: 'security',            iconLibrary: 'material',   color: '#FF4D5E' },
  Privacy:     { title: 'Privacy & Protection',   subtitle: 'Block, shred, WiFi, DNS, VPN',   icon: 'privacy-tip',         iconLibrary: 'material',   color: '#FFC94A' },
  Performance: { title: 'Performance & Speed',    subtitle: 'Profile, benchmark, TCP, CPU',   icon: 'speed',               iconLibrary: 'material',   color: '#2FE38A' },
  Cleaning:    { title: 'System Cleaning',        subtitle: 'Temp, Docker, git, pip, logs',   icon: 'cleaning-services',   iconLibrary: 'material',   color: '#38D9E8' },
  Backup:      { title: 'Backup & Recovery',      subtitle: 'Verify, sync, cloud, database',  icon: 'backup',              iconLibrary: 'material',   color: '#FF7A1F' },
  PCCheck:     { title: 'PC CHECK SUITE',          subtitle: 'Health · Clean · Audit · Diagnose', icon: 'heart-pulse',         iconLibrary: 'community',  color: '#2FE38A' },
};
...
try {
  setTimeout(() => {
    ...
    } catch (_inner) { try { require('@/services/autoErrorLogger').autoErrorLogger?.log?.('warn', '[scriptLibraryData validation]', String(_inner)); } catch {} }
  }, 5000);
} catch (_e) { try { require('@/services/autoErrorLogger').autoErrorLogger?.log?.('warn', '[scriptLibraryData init]', String(_e)); } catch {} }
