 ...
 * ║  ΦFUSE — Dual-channel synthesis before every Local Ollama call        ║
...
export interface NexusContext {
  ...
  fusedBlock:      string;                  // ΦFUSE — ready for Local Ollama
...
class NexusBridgeService {
   ...
   * Dual-channel knowledge amplification before every Local Ollama call.
   *
  ...
  private async _omegaLoop(
    ...
    if (added > 0) {
      // Fire-and-forget save (don't await — don't block Local Ollama call)
