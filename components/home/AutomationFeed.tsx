  ...
  return (
    <View style={s.wrap}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.headerSub}>SIM·PREVIEW</Text>
        <View style={{ flex: 1 }} />
        <View style={[s.previewBadge, { borderColor: C.amber + '55', backgroundColor: C.amber + '10' }]}>
          <MaterialIcons name="preview" size={9} color={C.amber} />
          <Text style={[s.previewTxt, { color: C.amber }]}>PREVIEW</Text>
        </View>
        <View style={[s.linkPill, { borderColor: linkColor + '60', backgroundColor: linkColor + '10', marginLeft: 4 }]}>
...
const s = StyleSheet.create({
  ...
  previewTxt: { fontSize: 7.5, fontWeight: '900', fontFamily: MONO, letterSpacing: 0.8 },
