 ...
 * v2: expo-linear-gradient REMOVED (banned package — black screen on APK install).
 *     All gradients replaced with solid View backgrounds.
 */
    ...
    <View style={s.wrap}>
      ...
      <View style={s.heroRow}>
        <View style={s.avatarWrap}>
          ...
          {/* Avatar ring — solid color replaces expo-linear-gradient */}
          <View style={[s.avatarRing, { backgroundColor: pr }]}>
      ...
      {/* ── 2. Live status card ──────────────────────────────────── */}
      <View style={[s.statusCard, { borderColor: pr + '30', backgroundColor: 'rgba(14,14,18,0.95)' }]}>
        ...
        {PROMPT_CARDS.map((c) => {
          ...
          return (
            <TouchableOpacity
              ...
              activeOpacity={0.78}
              onPress={() => tap(c.cmd)}
              style={[s.gridCard, { borderColor: c.hue + '40', backgroundColor: c.hue + '10' }]}
            >
      ...
      <TouchableOpacity
        ...
        style={[s.buildCta, { backgroundColor: 'rgba(0,255,136,0.08)' }]}
      >
