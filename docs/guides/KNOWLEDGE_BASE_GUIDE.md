...
- ✅ **Survives cache deletion** - backed up to the user's paired PC server database
...
| **Knowledge Base (Server)** | ✅ Safe | Synced to the user's paired PC server database |
...
- Uploads compressed research to the user's paired PC server
...
```
1. Install app
2. Login to the user's paired PC server account
...
### **Knowledge Base Tables (the user's paired PC server)**
```sql
...
2. Verify the user's paired PC server connection (Settings)
